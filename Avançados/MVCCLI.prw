...
oBrowse:SetDescription ('Meus Clientes') // SetDescription. Definimos o título que será exibido como método. 
...
oBrowse:AddLegend( "A1_TIPO=='S'", "RED"  ,   "Solidário"  )
oBrowse:AddLegend( "A1_TIPO=='X'", "ORANGE",  "Exportação"  )
...
ADD OPTION aRotina TITLE "Visualizar" 	ACTION "VIEWDEF.MVCCLI" OPERATION 2 ACCESS 0
ADD OPTION aRotina TITLE "Incluir"    	ACTION "VIEWDEF.MVCCLI" OPERATION 3 ACCESS 0
ADD OPTION aRotina TITLE "Alterar"    	ACTION "VIEWDEF.MVCCLI" OPERATION 4 ACCESS 0
ADD OPTION aRotina TITLE "Excluir"    	ACTION "VIEWDEF.MVCCLI" OPERATION 5 ACCESS 0
ADD OPTION aRotina TITLE "Imprimir" 	ACTION "VIEWDEF.MVCCLI" OPERATION 8 ACCESS 0
ADD OPTION aRotina TITLE "Legenda" 		ACTION "u_Lxxx()"        OPERATION 9 ACCESS 0
...
BrwLegenda(cCadastro,"", {{"BR_AZUL","L - Produtor rural"},;
								{"BR_LARANJA","X - Exportação"},;
								{"BR_VERDE","R - Revendedor"},;
								{"BR_VERMELHO","S - Solidário"},;
								{"BR_LARANJA","X - Exportação"}})
...
Local oStruZA0 := FWFormStruct( 1, 'SA1' ) //Com a função FWFormStruct a estrutura será criada a partir do metadado.
...
Local oModel := FWLoadModel( 'MVCCLI' ) //MVC01 é nome do fonte de onde queremos obter o modelo de dados (Model). 
